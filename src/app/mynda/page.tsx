...
export default function MyNDAsPage() {
    ...
    const getWorkflowLabel = (nda: NDA) => {
        ...
        if (nda.workflowState === 'AWAITING_PARTY_A_SIGNATURE') return { label: 'Waiting for you', style: 'bg-orange-100 text-orange-800 border-orange-200' }
        if (nda.workflowState === 'AWAITING_PARTY_A_REVIEW') return { label: 'Waiting for you', style: 'bg-orange-100 text-orange-800 border-orange-200' }
